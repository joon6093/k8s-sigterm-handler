...
public class SigtermHandlerConfiguration {
    ...
    @Bean
    public SignalHandlerRegistrar sigtermHandlerRegister(final ApplicationContext applicationContext) {
        final ApplicationTerminator applicationTerminator = new SpringContextTerminator(
                applicationContext,
                sigtermHandlerProperties.getExitCode(),
                sigtermHandlerProperties.getTerminationMessagePath(),
                sigtermHandlerProperties.getTerminationMessage());
